...
from apps.ddl_assistant.app import app as ddl_app  # <-- nou
...
site.mount("/apps/ddl", ddl_app)            # <-- nou
...
def home(request: Request):
    apps = [
        ...
        },
        {
            ...
            "path": "/apps/ddl/",
            "title": "DDL Assistant",
            "subtitle": "Descriere → DDL Postgres (preview)",
            "status": "beta",
            "tags": ["DDL", "Schema", "Indexes", "Ollama"]
        },
    ]
